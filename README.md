...
**推荐**：直接看[报告](https://sleepcloudmx.github.io/UnderstandingTokenization/docs/report.html)中的图表与讨论分析即可。如果需要上手跑测试，可以继续阅读。
...
<img src="docs/image/demo.png" alt="demo" width=600 />

> **注**：若使用 .md 或 .html 打开（如[报告](https://sleepcloudmx.github.io/UnderstandingTokenization/docs/report.html)），鼠标悬浮在字符上会显示对应的 token。由于 GitHub 对 README 中的 HTML 做了清晰，内联 style 被移除，因此 HTML 标签无法正常渲染，于是上面放的图片而不是 HTML。
